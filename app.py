...
def teams(team_uuid):
	try:
		...
		for game in team_game_data:
			...
			blue_team_players = [f"{player['riotIdGameName']}#{player['riotIdTagline']}" for player in players_data if player['teamId'] == 100]
			red_team_players = [f"{player['riotIdGameName']}#{player['riotIdTagline']}" for player in players_data if player['teamId'] == 200]
